### Solving Number Mind puzzles >10 different ways
...
Here’s how the algorithms performed:
...
I calculated the Bayesian probability of the solution having a particular digit in a particular place, given the distribution of guess scores with that digit either occurring or not occurring in that place. [Here’s my derivation](docs/NumberMindBayesianProbabilities.pdf). These probabilities were able to make many of the algorithms substantially faster.
